...
KURALLAR:
- MPN çoğu zaman urun_adi veya urun_aciklamasi İÇİNDE gizlidir.
...
function buildPrompt(item, knownCategories = []) {
    ...
    if (item.brand_name)        knownParts.push(`marka (şüpheli)   : "${item.brand_name}"`);
...
Gerçek MPN çoğu zaman urun_adi veya urun_aciklamasi İÇİNDE gizlidir. Örnekler:
  - "ASUS ExpertCenter D5 SFF D501SER-DI58512B0X-300" → MPN: D501SER-DI58512B0X-300
  - "High Cabinet for WF-C87XR"                        → model/MPN ipucu: WF-C87XR
  - "EPSON WF-C20590 BLACK 50.000SYF"                  → model ipucu: WF-C20590

ARAMA STRATEJİSİ:
1. MPN ADAYLARINI ÇIKAR. Önce urun_adi ve urun_aciklamasi metnini incele ve
   ...
   öncelikle.
2. MARKAYI BELİRLE. Ürün adından, açıklamadan ve kod kalıbından markayı tespit
